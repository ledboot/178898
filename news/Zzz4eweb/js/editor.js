...
config.IsIE7 = (navigator.userAgent.toLowerCase().indexOf("msie 7") != -1);
	...
	for (i=0; i<elements.length; i++) {
		...
		switch (element.className) {
			case "Btn":
				...
				break;
			case "TBGen":
				element.style.posLeft = y.TBWidth;y.TBWidth += element.offsetWidth + 1;
				break;
			case "TBSep":
...
function PasteWord(){
	...
	if(BrowserInfo.IsIE55OrMore){
		...
		confirm(lang["MsgNotCompatiblePaste"])){format("paste") ;
	}
	eWebEditor.focus();
}

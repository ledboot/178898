		...
		<center>
			<%
				If flag = "save" Then
					...
					if Answer = "" then
						Error1 "对不起，请选择题目答案!", "Admin_Questions_Add.asp?flag=add&id="&PaperId&"&tmtype=1"
					end if
					Set rs1 = rsSubjectLibrary1()
					rs1.AddNew
					rs1("PaperId") = PaperId
					rs1("Title") = Title
					rs1("Options") = Options
			...
			<table border="0" cellpadding="0" cellspacing="0" width="65%" align="center" bordercolorlight="#000000" bordercolordark="#F7F7F7">
				<tr> 
					<td align="center" height="25" style="border-left: 1 solid #C0C0C0;border-top: 1 solid #C0C0C0;border-right: 1 solid #C0C0C0;" background="images/admin_top_bg.jpg"><b>试题添加成功</b></td>
				</tr>
				<tr>
					<td align="center" bgcolor="#F7F7F7" style="border: 1 solid #C0C0C0"> 
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							...
							<tr>
								<td align="center" colspan="2" height="30"></a> <font color="#800000">◇</font> <a href="Admin_Questions_Add.asp?flag=add&papaerId=<%=PaperId%>&tmtype=1">继续添加</a> <font color="#800000">◇</font> <a href="Admin_Paper.asp?flag=man">返回</a></p></td>
							</tr>
						</table>
					</td>
					<%
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr> 
					<td height="30" bgcolor="#F7F7F7" style="border: 1 solid #C0C0C0;"><b>&nbsp;管理导航：</b><a href="javascript:history.back()">返回</a></td>
				</tr>
			</table>
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr> 
				...
				<tr> 
					<td align="center" bgcolor="#F7F7F7" style="border-left: 1 solid #C0C0C0; border-right: 1 solid #C0C0C0; border-bottom: 1 solid #C0C0C0"> 
						<form method="POST" action="?flag=save" name="form1">
							<table width="800px" border="1" align="center" cellpadding="0" cellspacing="0">
                            	<tr height="25">
                                    <th colspan="4"><input type="hidden" name="paperId" value="<%=papaerId%>"/></th>
                                </tr>
                            	<tr height="25">
                                	<td>试卷名称：</td>
                                    <th height="20" align="left" colspan="3"><%=rs2("Title")%></th>
                                </tr>
								<tr height="25"> 
									<td>题目类型：</td>
                                    <td height="20" align="left"> 
                                   <select name="tmtype"  id="tmtype">
								...
								<tr height="25"> 
									<td>题目标题：</td>
									<td colspan="3" align="left"><textarea name="contentTitle" style="display:none"></textarea><IFRAME ID="eWebEditor1" SRC="Zzz4eweb/ewebeditor.htm?id=contentTitle&style=coolblue" FRAMEBORDER="0" SCROLLING="no" WIDTH="550" HEIGHT="200"></IFRAME> <font color="#FF0000">*</font></td>
								</tr>
                                <tr height="25">
                                	<td>题目选项：</td>
                    ...
                    <label><input name="answer11" type="radio"  value="A" checked>
                    A </label>
                   <label><input type="radio" name="answer11"  value="B">
                    B</label> 
                    <label><input type="radio" name="answer11"  value="C">
                    C</label> 
                    <label><input type="radio" name="answer11"  value="D">
                    D</label> </div>
                  <div name="answer2" id="answer2" <%if tmtype<>2 then response.write " style='display:none'"%>> 
                    <label><input type="checkbox" name="answer22"  value="A">
                    A</label> 
                    <label><input type="checkbox" name="answer22" value="B">
                    B</label> 
                    <label><input type="checkbox" name="answer22" value="C">
                    C </label>
                    <label><input type="checkbox" name="answer22" value="D">
                    D</label> 
					
				  </div>
                  
                  <div name="answer3" id="answer3"<%if tmtype<>3 then response.write " style='display:none'"%>> 
                   <label> <input type="checkbox" name="answer33"  value="A">
                    A </label>
                    <label><input type="checkbox" name="answer33" value="B">
                    B </label>
                    <label><input type="checkbox" name="answer33" value="C">
                    C </label>
                   <label><input type="checkbox" name="answer33" value="D">
                    D</label> 
                   <label> <input type="checkbox" name="answer33" value="E">
                    E </label>
					</div>
                    
					<div name="answer4" id="answer4"<%if tmtype<>4 then response.write " style='display:none'"%>> 
                    <label><input type="checkbox" name="answer44"  value="A">
                    A</label> 
                    <label><input type="checkbox" name="answer44" value="B">
                    B</label> 
                    <label><input type="checkbox" name="answer44" value="C">
                    C</label> 
                    <label><input type="checkbox" name="answer44" value="D">
                    D </label>
                    <label><input type="checkbox" name="answer44" value="E">
                    E</label> 
                   <label> <input type="checkbox" name="answer44" value="F">
                    F</label> 
					</div>
					
                    <div name="answer5" id="answer5"<%if tmtype<>5 then response.write " style='display:none'"%>> 
                   <label> <input name="answer55" type="radio" value="1" checked>
                    对</label> 
                    <label><input type="radio" name="answer55" value="0">
                    错</label> </div>
                                    </th>
                                </tr>
								<tr height="25" align="center"> 
									<td colspan="4"><input type="button" value="添加" name="B1" onClick="add()"></td>
								</tr>
							</table>
						</form>
					</td>

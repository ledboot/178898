    ...
    <tr> 
      <td> 
        <table width="100%" border="0" cellspacing="0" cellpadding="4">
          <form name="form1" method="post" action="link_save.asp">
            <tr> 
              <td width="20%" align="right">链接名称：</td>
              <td width="80%"> 
                <input type="text" name="linkname" size="40" maxlength="40">
                <font color="#FF0000">* </font></td>
            </tr>
            <tr> 
              <td width="20%" align="right">链接地址：</td>
              <td width="80%"> <font color="#FF0000"> 
                <input type="text" name="linkwww" size="40">
                *<br> 例：http://www.0733168.com/</font></td>
            </tr>
			<%
				If lx = 0 Then
			%>
